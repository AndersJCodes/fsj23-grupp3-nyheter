...
const displayWelome = document.querySelector(".welcome");
...
onAuthStateChanged(auth, (user) => {
  ...
  if (user === null) {
    ...
    displayWelome.style.display = "none";
  }
  if (user !== null) {
    ...
    displayWelome.style.display = "block";
    displayWelome.innerHTML = "Welcome " + user.email
  }
});
